...
class CategorySeeds extends StatefulWidget {
  const CategorySeeds({super.key});

  @override
  State<CategorySeeds> createState() => _CategorySeedsState();
}

class _CategorySeedsState extends State<CategorySeeds> {
  @override
    ...
    return Scaffold(
      ...
      body: Consumer<ProductData>(
        builder: (context, productData, child) {
          List<Product> products = productData.seeds;
